<template>
  ...
  <!-- Floating WhatsApp Container (bottom right) -->
  <div class="floating-wa-wrapper">
    <Transition name="bubble-fade">
      <div v-if="showChatBubble" class="floating-wa-greeting">
        <button type="button" class="floating-wa-greeting__close" @click="closeChatBubble" aria-label="Tutup pesan">
        ...
        <p class="floating-wa-greeting__text">
          Ingin konsultasi bisnis?<br />Silakan hubungi kami!
        </p>
      </div>
    </Transition>
...
.floating-wa-greeting__close:hover {
  background: #D1D5DB;
  color: #1F2937;
}
